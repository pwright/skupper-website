...
You can  n use   name of   terminal you have already created. This does not work if you create an unnamed terminal. The code searches for   terminal name and creates it if it doesn't already exist.

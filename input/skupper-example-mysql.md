...
* [Step 3: Deploy the database server](#step-3-deploy-the-database-server)
* [Step 4: Create your sites](#step-4-create-your-sites)
* [Step 5: Link your sites](#step-5-link-your-sites)
* [Step 6: Expose the database server](#step-6-expose-the-database-server)
* [Step 7: Run the database client](#step-7-run-the-database-client)
...
## Step 3: Deploy the database server
...
## Step 6: Expose the database server
...
## Step 7: Run the database client
